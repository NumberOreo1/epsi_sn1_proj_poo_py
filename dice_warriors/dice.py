...
#         self.__vitesse_max = 250
       
#     def setVitesseMax(self, vit):
#         if vit > self.__vitesse_max:
#             return "Error"
#         else:
#             self.__vitesse_max = vit
        
# ma_voiture = Voiture()
# # ma_voiture.setVitesseMax(800)
# ma_voiture.__vitesse_max = 1200
